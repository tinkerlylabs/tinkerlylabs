...
export default function CTASection({ onJoinClick }: CTASectionProps) {
  return (
    <section className="relative w-full py-12 px-4 md:px-6 z-10 bg-[#F9FAF7]">
      <div
        className="max-w-4xl mx-auto relative rounded-[2.5rem] overflow-hidden shadow-2xl py-16 md:py-20 px-6 flex flex-col items-center justify-center text-center transform-gpu"
      >
        {/* Gradient background */}
        <div
        ...
        <div
          className="absolute inset-0 opacity-20 mix-blend-screen pointer-events-none transform-gpu"
